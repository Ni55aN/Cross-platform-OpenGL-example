...
public class NativeOpenGLSurface extends GLSurfaceView implements GLSurfaceView.Renderer,View.OnTouchListener, KeyEvent.Callback {
    static {
    ...
    public NativeOpenGLSurface(Context context) throws Exception {
        super(context);
        ...
        if (configurationInfo.reqGlEsVersion >= 0x20000) {
            ...
            throw new Exception("This device does not support OpenGL ES 2.0");
        }
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (actionMask) {
            case MotionEvent.ACTION_DOWN:  nativeDown(pointerId,x,y);
            case MotionEvent.ACTION_POINTER_DOWN:  break;
            case MotionEvent.ACTION_MOVE: nativeMove(pointerId,x,y); break;
            case MotionEvent.ACTION_CANCEL: nativeUp(pointerId,x,y);
            case MotionEvent.ACTION_UP: nativeUp(pointerId,x,y);
